...
public class DRPCRequest implements org.apache.thrift.TBase<DRPCRequest, DRPCRequest._Fields>, java.io.Serializable, Cloneable, Comparable<DRPCRequest> {
  ...
  public int hashCode() {
    ...
    boolean present_func_args = true && (isSetFunc_args());
    list.add(present_func_args);
    if (present_func_args)
      list.add(func_args);

    boolean present_request_id = true && (isSetRequest_id());
  ...
  public int compareTo(DRPCRequest other) {
    ...
    lastComparison = Boolean.valueOf(isSetFunc_args()).compareTo(other.isSetFunc_args());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(isSetRequest_id()).compareTo(other.isSetRequest_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRequest_id()) {
