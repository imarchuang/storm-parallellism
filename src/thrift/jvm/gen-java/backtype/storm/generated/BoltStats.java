...
public class BoltStats implements org.apache.thrift.TBase<BoltStats, BoltStats._Fields>, java.io.Serializable, Cloneable, Comparable<BoltStats> {
  ...
  public int compareTo(BoltStats other) {
    ...
    lastComparison = Boolean.valueOf(isSetProcess_ms_avg()).compareTo(other.isSetProcess_ms_avg());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetExecute_ms_avg()).compareTo(other.isSetExecute_ms_avg());
    if (lastComparison != 0) {
      return lastComparison;
    }
