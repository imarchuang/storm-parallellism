...
public class JavaObject implements org.apache.thrift.TBase<JavaObject, JavaObject._Fields>, java.io.Serializable, Cloneable, Comparable<JavaObject> {
  ...
  public int hashCode() {
    ...
    boolean present_full_class_name = true && (isSetFull_class_name());
  ...
  public int compareTo(JavaObject other) {
    ...
    lastComparison = Boolean.valueOf(isSetFull_class_name()).compareTo(other.isSetFull_class_name());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(isSetArgs_list()).compareTo(other.isSetArgs_list());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetArgs_list()) {
